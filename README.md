...
Blog Zombie docs were created by extending upon HUGO's Doks-template. HUGO is a static-site generator which creates static sites from markdown documents.

The Doks template is familiar to developers and allows us to create a documentation site quickly. Furthermore, the statically generated site is SEO-friendly (we want people to find our docs).

Please see additional information about Dok and HUGO; included below.
